...
# VPC Configuration
# ---------------------------------------------------------------------------------------------------------------------
# This _envcommon file defines the shared VPC configuration used by all environments.
# It provisions a multi-AZ VPC with public, private, and database subnets using
# the terraform-aws-modules/vpc/aws registry module.
#
